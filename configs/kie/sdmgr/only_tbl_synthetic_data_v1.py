...
data_root = '/data/jioai/indu/datasets/only_tbl_synthetic_data_v1'
loader = dict(
    type='HardDiskLoader',
    repeat=1,
    parser=dict(
...
train = dict(
    type=dataset_type,
    ann_file=f'{data_root}/only_tbl_synth_train_v1.txt',
    pipeline=train_pipeline,
    img_prefix='/data/jioai/indu/datasets/only_tbl_synthetic_data_v1/',
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
    test_mode=False)
val = dict(
    type=dataset_type,
    ann_file=f'{data_root}/only_tbl_synth_val_v1.txt',
...
test = dict(
    type=dataset_type,
    ann_file=f'{data_root}/only_tbl_synth_test_v1.txt',
...
real = dict(
    ...
    pipeline=test_pipeline,
    img_prefix="/data/jioai/indu/datasets/only_tbl_synthetic_data_v1/",#"/data/jioai/indu/datasets/only_tbl_synthetic_data_v1_cropped/",
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
    test_mode=True)
...
tmp = dict(
    type=dataset_type,
    ann_file=f'{data_root}/train1.txt',
    pipeline=test_pipeline,
    img_prefix="/data/jioai/indu/datasets/only_tbl_synthetic_data_v1/",
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
