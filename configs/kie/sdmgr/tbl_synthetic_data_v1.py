...
data_root = '/data/jioai/indu/datasets/tbl_synthetic_data_v1'
loader = dict(
    type='HardDiskLoader',
    repeat=1,
    parser=dict(
...
train = dict(
    type=dataset_type,
    ann_file=f'{data_root}/tbl_synth_train_v1.txt',
    pipeline=train_pipeline,
    img_prefix='/data/jioai/indu/datasets/tbl_synthetic_data_v1/',
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
    test_mode=False)
val = dict(
    type=dataset_type,
    ann_file=f'{data_root}/tbl_synth_val_v1.txt',
...
test = dict(
    type=dataset_type,
    ann_file=f'{data_root}/tbl_synth_test_v1.txt',
...
real = dict(
    type=dataset_type,
    ann_file=f'{data_root}/real_tbl_data.txt',
    pipeline=test_pipeline,
    img_prefix="/data/jioai/indu/datasets/tbl_synthetic_data_v1/",
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
