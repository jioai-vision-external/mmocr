...
data_root = '/data/jioai/indu/datasets/6k_test_data_all'
loader = dict(
    type='HardDiskLoader',
    repeat=1,
    parser=dict(
...
train = dict(
    type=dataset_type,
    ann_file=f'{data_root}/train_v2.txt',
...
val = dict(
    type=dataset_type,
    ann_file=f'{data_root}/val_v2.txt',
...
test = dict(
    type=dataset_type,
    ann_file=f'{data_root}/test_v2.txt',
...
# closed_real_word_level_temp.txt',
temp = dict(
    type=dataset_type,
    ann_file=f'{data_root}/closed_real_word_level_modified_K_V_temp.txt',
    pipeline=test_pipeline,
    img_prefix="/data/",
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
...
real = dict(
    type=dataset_type,
    ann_file=f'{data_root}/real_data_v1_all.txt',
    pipeline=test_pipeline,
    img_prefix='/data/jioai/indu/datasets/6k_test_data/image_files',
    loader=loader,
    dict_file=f'{data_root}/dict.txt',
    test_mode=True)
